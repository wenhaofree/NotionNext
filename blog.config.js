...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '15828842492280a7aab5c411df8edb6a,en:15828842492280a7aab5c411df8edb6a',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'AIGPTGOD', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '专业AI技术资讯平台 | 人工智能前沿资讯 | AI工具评测 | 技术教程', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://aigptgod.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'AI技术,人工智能,机器学习,深度学习,AI工具,GPT,ChatGPT,AI资讯,技术博客,AI教程,自然语言处理,计算机视觉,AI应用,人工智能发展,AI前沿技术', // 网站关键词 英文逗号隔开
  ...
  ADSENSE_GOOGLE_SLOT_FLOW:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_FLOW || '1601798887', // Google AdScene>广告>按单元广告>新建信息流广告
  ADSENSE_GOOGLE_SLOT_NATIVE:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_NATIVE || '8186618027', // Google AdScene>广告>按单元广告>新建原生广告
